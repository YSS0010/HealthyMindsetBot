...
client.on('disconnect', () => console.log('I just disconnected, logged, reconnecting...'));
...
client.on('message', async msg => { // eslint-disable-line
	...
	if (command === 'play') {
		...
		if (!permissions.has('CONNECT')) {
			return msg.channel.send('I cannot connect to your voice channel,check permissions!');
		}
